...
//בעית המטוס:
// נתונה מטריצה m × n כאשר לכל תא יש מחיר מעבר לתא שמימינו x ולתא שמעליו y.
//המטרה: למצוא את המסלול בעל המחיר הכולל הנמוך ביותר מתא (0, 0) לתא (m, n)
//מותר לזוז רק למעלה או ימינה.
class Node {
