...
//// לא גמור!!!
//
////  ממשו אלגוריתם אופטימאלי עבור משחק המספרים עם 2 מערכים
////  כאשר בכל שלב מותר לקחת איבר מהצד השמאלי או הימני של המערך הראשון או השני
//
//public class NumberGame_TwoArr {
